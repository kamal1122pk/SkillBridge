...
SECRET_KEY = 'django-insecure-w&3p$99zlws1@%fhk+t0ykn75&zuzpk99e!f6hlif3$6r%2y(!'
...
STORAGES = {
    ...
    "staticfiles": {
        # Change this from CompressedManifestStaticFilesStorage to just CompressedStaticFilesStorage
